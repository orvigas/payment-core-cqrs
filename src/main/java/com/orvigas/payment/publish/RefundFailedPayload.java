...
/**
 * Kafka payload for {@link RefundFailed}, published to
...
public record RefundFailedPayload(
    ...
    private static final String EVENT_TYPE = "RefundFailed";
     ...
     */
    public static RefundFailedPayload from(RefundFailed event) {
        Objects.requireNonNull(event, "event must not be null");
        return new RefundFailedPayload(
