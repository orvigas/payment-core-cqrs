...
- **Kafka** (Spring Kafka) with topics `payment-initiated`, `payment-charged`, `payment-completed`, `payment-failed`, `payment-refunded` (see ADR-002 for the full event-to-topic mapping).
