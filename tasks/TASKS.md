...
| [T-007](T-007-payment-kafka-publisher.md) | Kafka event publisher for payment domain events | backlog | none | T-003 |
| [T-008](T-008-payment-rest-api.md) | Payment REST API | backlog | none | T-003, T-004 |
| [T-009](T-009-merchant-aggregate.md) | Merchant aggregate with onboarding and lifecycle commands | backlog | none | T-001, T-002 |
...
| [T-012](T-012-observability-wiring.md) | Observability wiring (metrics, tracing, structured logs) | backlog | none | — |
