...
| [T-009](T-009-merchant-aggregate.md) | Merchant aggregate with onboarding and lifecycle commands | in-progress | general | T-001, T-002 |
...
| [T-012](T-012-observability-wiring.md) | Observability wiring (metrics, tracing, structured logs) | in-progress | general | — |
